...
-------------------------------------------------- Link for the challenge: https://codeforces.com/contest/2236/problem/B --------------------------------------
...
Arseniy can make an unlimited number of moves. In one move, he can choose an integer i (1≤i≤n−k) 
and invert the characters at positions i and i+k, that is, change 0 to 1 and 1 to 0.
