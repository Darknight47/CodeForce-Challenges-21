...
---------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/2233/A   -------------------------------
...
The project is considered completed as soon as Maxim and Nikita together have written at least n lines of code. 
If the project can be completed before the AI setup ends, then the work ends at that moment.
...
The only line of each test case contains four integers n, x, y, and z (1≤n,x,y,z≤10000) — the number of lines in the project, Maxim's speed, Nikita's speed without AI, 
and the AI setup time, respectively.
...
for _ in range(cases):
    ...
    if x * z >= n:
        ...
        remaining = n - x * z
        ai = z + math.ceil(remaining / (x + 10 * y))
